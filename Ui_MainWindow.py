...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageCorelations = QtWidgets.QTableView(self.verticalLayoutWidget)
        ...
        self.renameAnnotationsButton.setIcon(icon5)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(':/icons/32x32/go-jump.png'),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.hideLabelsButton.setIcon(icon8)
